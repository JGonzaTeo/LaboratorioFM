...
namespace Capa_Datos
{
    public class Sentencias
    {
       ...
       public OdbcDataReader consultaayudas(string id)
        ...
        public OdbcDataReader Insertarconcepto(string sCodigo, string sNombre, string sdireccion, string stelefono, string sestado)
        {
            try
            {
                cn.conexionbd();
        ...
        public OdbcDataReader modificarconcepto(string sCodigo, string sNombre, string sdireccion, string stelefono,string sestado)
        {
            try
            {
                cn.conexionbd();
